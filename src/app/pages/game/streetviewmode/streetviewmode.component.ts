...
import { RandomstreetviewsService } from '../../../services/randomstreetviews.service';
@Component({
  selector: 'app-streetviewmode',
  imports: [CommonModule,SvMaplibreComponent],
  templateUrl: './streetviewmode.component.html',
  styleUrl: './streetviewmode.component.css'
})
export class StreetviewmodeComponent {
